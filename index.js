...
HaxballJS().then((HBInit) => {
    ...
    function manageTeams(winnerTeam) {
        ...
        // CORREÇÃO: Remove o excesso de jogadores se alguém sair no meio do jogo (ex: 2v1 vira 1v1)
        ...
        // Inicia automaticamente apenas se a partida estiver parada e os times estiverem iguais e completos
